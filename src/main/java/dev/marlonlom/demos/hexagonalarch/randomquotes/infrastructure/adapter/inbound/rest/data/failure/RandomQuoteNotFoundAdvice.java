...
/**
 * Global exception handler for handling {@link RandomQuoteNotFound} exceptions
 * thrown by the application. <br>
 * <br>
 * Intercepts the exception and returns a standardized JSON error response with
...
public class RandomQuoteNotFoundAdvice {
	...
	/**
	 * Handles {@link RandomQuoteNotFound} exceptions and maps them to a
	 * {@link RandomQuoteFailure} error response.
	 *
	 * @param exception the exception that was thrown when a random quote was not
	 *                  found
	 * @return a {@link RandomQuoteFailure} object containing the error message
	 */
	@ExceptionHandler(exception = RandomQuoteNotFound.class, produces = MediaType.APPLICATION_JSON_VALUE)
