 ...
 * This component is responsible for converting {@link RandomQuote} domain entities into {@link
 * RandomQuoteResponse} or related DTOs for API responses.
 *
 * @author marlon.lopez
 * @version 1.0.0
 */
...
public class RandomQuoteResponseRestMapper {
    ...
    /**
     * Converts a {@link RandomQuote} domain object into a {@link RandomQuoteResponse} suitable for
     * REST API responses.
     *
    ...
    public RandomQuoteResponse toRandomQuoteResponse(RandomQuote randomQuoteDomainObject) {
        ...
        response.setQuote(
                RandomQuoteResponseItem.builder()
                        .id(randomQuoteDomainObject.getId())
                        .authorId(randomQuoteDomainObject.getAuthor_id())
                        .author(randomQuoteDomainObject.getAuthor())
                        .text(randomQuoteDomainObject.getText())
                        .tags(String.join(",", randomQuoteDomainObject.getTags()).trim())
                        .build());
        return response;
    }
}
