...
public interface RandomQuoteOutboundPort {
	 ...
	 * 
	 * <p>
	 * This method makes a call to an external source and maps the response to the
	 * domain model {@link RandomQuote}. If no quote is found or the request fails,
	 * an empty {@link Optional} is returned.
	 * </p>
	 *
	 * @return an {@link Optional} containing a {@link RandomQuote} if successfully
	 *         retrieved, or empty otherwise
	 */
