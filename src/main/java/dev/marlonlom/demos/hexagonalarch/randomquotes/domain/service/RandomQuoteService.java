 ...
 * <p>
 * This class implements the {@link GetRandomQuoteUseCase} interface, which
 * defines the contract for fetching random quotes.
 * </p>
 * 
 * @author marlon.lopez
 * @version 1.0.0
...
public class RandomQuoteService implements GetRandomQuoteUseCase {
	...
	@Autowired
	private RandomQuoteOutboundPort randomQuoteOutputPort;

	@Override
	public RandomQuote getRandomQuote() {
		return this.randomQuoteOutputPort.getRandomQuote().orElseThrow(() -> new RandomQuoteNotFound());
	}
